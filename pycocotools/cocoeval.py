...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeKps():
            ...
            stats[7] = _summarize(1, maxDets=20, areaRng="medium")
            stats[8] = _summarize(1, maxDets=20, areaRng="large")
            stats[9] = _summarize(0, maxDets=20)
            stats[10] = _summarize(0, maxDets=20, iouThr=0.5)
            stats[11] = _summarize(0, maxDets=20, iouThr=0.75)
            stats[12] = _summarize(0, maxDets=20, areaRng="medium")
            stats[13] = _summarize(0, maxDets=20, areaRng="large")
            return stats
