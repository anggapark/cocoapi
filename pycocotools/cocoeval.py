...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeKps():
            ...
            stats[2] = _summarize(1, maxDets=20, iouThr=0.55)
            stats[3] = _summarize(1, maxDets=20, iouThr=0.6)
            stats[4] = _summarize(1, maxDets=20, iouThr=0.65)
            stats[5] = _summarize(1, maxDets=20, iouThr=0.7)
            stats[6] = _summarize(1, maxDets=20, iouThr=0.75)
            stats[7] = _summarize(1, maxDets=20, iouThr=0.8)
            stats[8] = _summarize(1, maxDets=20, iouThr=0.85)
            stats[9] = _summarize(1, maxDets=20, iouThr=0.9)
            stats[10] = _summarize(1, maxDets=20, iouThr=0.95)
            stats[11] = _summarize(1, maxDets=20, areaRng="medium")
            stats[12] = _summarize(1, maxDets=20, areaRng="large")
            stats[13] = _summarize(0, maxDets=20)
            stats[14] = _summarize(0, maxDets=20, iouThr=0.5)
            stats[15] = _summarize(0, maxDets=20, iouThr=0.75)
            stats[16] = _summarize(0, maxDets=20, areaRng="medium")
            stats[17] = _summarize(0, maxDets=20, areaRng="large")
            return stats
